...
public class UsuarioControllerTest {
	...
	public void start() throws ParseException {
        ...
        LocalDate dataPost = LocalDate.parse("2000-08-16", DateTimeFormatter.ofPattern("yyyy-MM-dd"));
       ...
       usuario = new Usuario(0, "Administrador", "admin@email.com.br", "admin123", dataPost);
        ...
        usuarioUpdate = new Usuario(6L, "Rique", "rique@gmail.com", "rique123", dataPut);
	}
